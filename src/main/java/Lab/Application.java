...
public class Application {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(500);
		System.out
				.println("First, let's show off the working functionality of transactions & rollbacks for containers.");
		...
		System.out.println(
				"Next, let's test your ships functionality. These two ships ought to be correctly persisted: ");
